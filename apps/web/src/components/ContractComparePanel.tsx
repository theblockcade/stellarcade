          ...
          >
            ...
            <div className="compare-panel__cell">
              {leftMetric ? (
                <>
                  <span
                    data-testid={`${testId}-left-value-${label.replace(/\s+/g, "-").toLowerCase()}`}
                  >
                    {leftMetric.value}
                    {leftMetric.unit ? ` ${leftMetric.unit}` : ""}
                  </span>
            ...
            <div className="compare-panel__cell">
              {rightMetric ? (
                <>
                  <span
                    data-testid={`${testId}-right-value-${label.replace(/\s+/g, "-").toLowerCase()}`}
                  >
                    {rightMetric.value}
                    {rightMetric.unit ? ` ${rightMetric.unit}` : ""}
                  </span>
