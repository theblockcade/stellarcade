...
import type { QuestCardProps, QuestProgress } from "../types/quest";
  ...
  return (
    ...
    >
      <div className="quest-card__header">
        <div className="quest-card__category">{quest.category ?? "Quest"}</div>
        {quest.enrolled && (
        ...
        <div className="quest-card__milestones">
          ...
          <ul className="quest-card__milestones-list">
            {quest.milestones.slice(0, 3).map((milestone) => (
              <li
                key={milestone.id}
                className={`quest-card__milestone ${
                  milestone.completed ? "quest-card__milestone--completed" : ""
                }`}
              >
