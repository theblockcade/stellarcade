...
import type { QuestProgressRingProps } from "../types/quest";
    ...
    >
      ...
      >
        ...
        <defs>
          <linearGradient
            ...
            y2="0%"
          >
            <stop offset="0%" stopColor={effectiveColors.fillGradientStart} />
            <stop offset="100%" stopColor={effectiveColors.fillGradientEnd} />
          </linearGradient>
        </defs>
      ...
      {(label || subtitle) && (
        <div className="quest-progress-ring__info">
          {label && (
            <div className="quest-progress-ring__label" data-testid="quest-progress-ring-label">
              {label}
            </div>
          )}
          {subtitle && (
