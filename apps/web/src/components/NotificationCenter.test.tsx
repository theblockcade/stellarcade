...
describe("NotificationCenter", () => {
  ...
  it("shows deferred notifications in the queued view", () => {
    ...
    expect(screen.getByTestId("notification-center-deferred-list")).toHaveTextContent("toast-3");
  });
  ...
  it("renders a stable empty panel when showWhenEmpty is enabled", () => {
    ...
    expect(screen.getByTestId("notification-center-empty-panel")).toHaveTextContent("No notifications yet");
  });
});
