...
describe('QueueHealthWidget', () => {
  ...
  describe('Auto-refresh Functionality', () => {
    it('auto-refreshes at specified interval', async () => {
      ...
      // Fast-forward 5 seconds. waitFor's own polling uses real timers, which
      // deadlocks against vi.useFakeTimers() (nothing advances between polls) —
      // so assert directly after act() flushes the interval callback instead.
      await act(async () => {
